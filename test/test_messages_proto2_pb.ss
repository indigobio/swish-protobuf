...
(define-message TestAllTypesProto2
  ...
  (repeated_nested_message (list (message TestAllTypesProto2.NestedMessage)) 48)
  (repeated_foreign_message (list (message ForeignMessageProto2)) 49)
  (repeated_nested_enum (list (enum TestAllTypesProto2.NestedEnum)) 51)
  (repeated_foreign_enum (list (enum ForeignEnumProto2)) 52)
  ...
  (packed_nested_enum (list (enum TestAllTypesProto2.NestedEnum)) 88)
  ...
  (unpacked_nested_enum (list (enum TestAllTypesProto2.NestedEnum)) 102)
...
(define-message UnknownToTestAllTypes
  ...
  (repeated_int32 (list int32) 1011))
...
(define-message ProtoWithKeywords
  (inline int32 1)
  (concept string 2)
  (requires (list string) 3))

(define-message TestAllRequiredTypesProto2
  (required_int32 int32 1)
  (required_int64 int64 2)
  (required_uint32 uint32 3)
  (required_uint64 uint64 4)
  (required_sint32 sint32 5)
  (required_sint64 sint64 6)
  (required_fixed32 fixed32 7)
  (required_fixed64 fixed64 8)
  (required_sfixed32 sfixed32 9)
  (required_sfixed64 sfixed64 10)
  (required_float float 11)
  (required_double double 12)
  (required_bool bool 13)
  (required_string string 14)
  (required_bytes bytes 15)
  (required_nested_message (message TestAllRequiredTypesProto2.NestedMessage) 18)
  (required_foreign_message (message ForeignMessageProto2) 19)
  (required_nested_enum (enum TestAllRequiredTypesProto2.NestedEnum) 21)
  (required_foreign_enum (enum ForeignEnumProto2) 22)
  (required_string_piece string 24)
  (required_cord string 25)
  (recursive_message (message TestAllRequiredTypesProto2) 27)
  (optional_recursive_message (message TestAllRequiredTypesProto2) 28)
  (default_int32 int32 241)
  (default_int64 int64 242)
  (default_uint32 uint32 243)
  (default_uint64 uint64 244)
...
(define-message TestAllRequiredTypesProto2.NestedMessage
  (a int32 1)
  (corecursive (message TestAllRequiredTypesProto2) 2)
  (optional_corecursive (message TestAllRequiredTypesProto2) 3))

(define-message TestAllRequiredTypesProto2.Data
  (group_int32 int32 202)
  (group_uint32 uint32 203))

(define-message TestAllRequiredTypesProto2.MessageSetCorrect)

(define-message TestAllRequiredTypesProto2.MessageSetCorrectExtension1
  (str string 25))

(define-message TestAllRequiredTypesProto2.MessageSetCorrectExtension2
  (i int32 9))

(define-enum TestAllRequiredTypesProto2.NestedEnum
  (FOO 0)
  (BAR 1)
  (BAZ 2)
  (NEG -1))
