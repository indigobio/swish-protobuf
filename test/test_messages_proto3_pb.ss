...
(define-message TestAllTypesProto3
  ...
  (repeated_nested_message (repeated (message TestAllTypesProto3.NestedMessage)) 48)
  (repeated_foreign_message (repeated (message ForeignMessage)) 49)
  (repeated_nested_enum (repeated (enum TestAllTypesProto3.NestedEnum)) 51)
  (repeated_foreign_enum (repeated (enum ForeignEnum)) 52)
  ...
  (packed_nested_enum (repeated (enum TestAllTypesProto3.NestedEnum)) 88)
  ...
  (unpacked_nested_enum (repeated (enum TestAllTypesProto3.NestedEnum)) 102)
  ...
  (repeated_bool_wrapper (repeated (message BoolValue)) 211)
  (repeated_int32_wrapper (repeated (message Int32Value)) 212)
  (repeated_int64_wrapper (repeated (message Int64Value)) 213)
  (repeated_uint32_wrapper (repeated (message UInt32Value)) 214)
  (repeated_uint64_wrapper (repeated (message UInt64Value)) 215)
  (repeated_float_wrapper (repeated (message FloatValue)) 216)
  (repeated_double_wrapper (repeated (message DoubleValue)) 217)
  (repeated_string_wrapper (repeated (message StringValue)) 218)
  (repeated_bytes_wrapper (repeated (message BytesValue)) 219)
  ...
  (repeated_struct (repeated (message Struct)) 324)
  (repeated_any (repeated (message Any)) 315)
  (repeated_value (repeated (message Value)) 316)
  (repeated_list_value (repeated (message ListValue)) 317)
